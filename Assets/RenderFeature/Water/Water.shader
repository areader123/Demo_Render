    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(v2f i, float face : VFACE) : SV_Target
            {
                ...
                sssColor = SubsurfaceScattering(viewDir, lightDir, bump, _SSSDistortion, _SSSPower, _SSSScale) *
                    _SSSColor;
                ...
                float foam = saturate(dot(float3(_FoamDirection.x, 0, _FoamDirection.y), bump)) * smoothstep(
                    _FoamDirection.z, _FoamDirection.w, worldPos.y);
                foam *= foamNoise;
                ...
                float2 parallaxOffset = ParallaxOffset1Step(1 - waterDepthDifference01, _CausticsParallaxScale,
                                      viewDirTS);
