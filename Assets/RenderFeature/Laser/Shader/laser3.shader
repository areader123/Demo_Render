//加入reflect后，视角变化造成的颜色变化更加明显 使用了两张ramp图 效果上第二张ramp图压暗了第一张的效果
...
Shader "Unlit/laser3"
{
       Properties
    {
        ...
        _AoPower ("AO Power", Range(0, 1)) = 0.1
    ...
    SubShader
    {
        Pass
        {
            ...
            #include "Assets\RenderFeature\ShaderLibs\LcLLighting.cginc"
            ...
            half _Hue, _Saturation, _Brightness, _Contrast,_Strength;
            ...
            fixed4 LaserFragment(Varyings i) : SV_Target
            {
                ...
                half4 finalColor = LcLFragmentPBR(surfaceData, inputData, gi) * _Strength;
