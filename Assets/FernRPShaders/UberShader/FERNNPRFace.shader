...
//        [Sub(DissolveSetting)] _DissolveThreshold ("Dissolve Threshold", Range(0, 1)) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "NPRStandardInput.hlsl"
            #include "Assets/FernShaderLibrary/ShadowCasterPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "NPRStandardInput.hlsl"
            #include "Assets/FernShaderLibrary/DepthOnlyPass.hlsl"
            ENDHLSL
        }
...
//        }
        ...
        Pass
        {
            ...
            #include "NPRStandardInput.hlsl"
            #include "Assets/FernShaderLibrary/NormalOutline.hlsl"
            ENDHLSL
        }
    }
