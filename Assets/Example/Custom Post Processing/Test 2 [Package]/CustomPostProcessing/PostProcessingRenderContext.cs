...
namespace Example.CustomPostProcessing
{
    public class PostProcessingRenderContext
    {
        ...
        {
            private static Dictionary<RenderTargetIdentifier, RenderTargetHandle> _usingTempRTs 
                = new Dictionary<RenderTargetIdentifier, RenderTargetHandle>();
            private static int _tempIndex;
            public static RenderTargetIdentifier Request(CommandBuffer cmd, 
