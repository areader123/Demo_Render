...
Shader "RainDrop_PBR"
{
	Properties
	{
		...
		[ASEEnd]_TintColor1("TintColor", Color) = (0.5019608,0.5019608,0.5019608,0.5019608)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_output_7_0 = ( tex2D( _TextureSample1, uv_TextureSample1 ) * IN.ase_color * _TintColor1 * 2.0 );
				half3 reflectVector8 = reflect( -WorldViewDirection, WorldNormal );
				float3 indirectSpecular8 = GlossyEnvironmentReflection( reflectVector8, 1.0 - 0.7, 1.0 );
				
				float clampResult12 = clamp( (temp_output_7_0).a , 0.0 , 1.0 );
				
				float3 Albedo = ( (temp_output_7_0).rgb + indirectSpecular8 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half3 reflectVector8 = reflect( -ase_worldViewDir, ase_worldNormal );
				float3 indirectSpecular8 = GlossyEnvironmentReflection( reflectVector8, 1.0 - 0.7, 1.0 );
...
/*ASEBEGIN
Version=18500
0;77.33334;1400.333;582.3333;1743.844;238.4639;1.3;True;False
Node;AmplifyShaderEditor.RangedFloatNode;6;-1127.875,234.7118;Inherit;False;Constant;_Float1;Float 0;3;0;Create;True;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;13;-1222.194,30.93089;Inherit;False;Property;_TintColor1;TintColor;1;0;Create;True;0;0;False;0;False;0.5019608,0.5019608,0.5019608,0.5019608;0.5019608,0.5019608,0.5019608,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;14;-1145.253,-134.4749;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;15;-1258.875,-379.2882;Inherit;True;Property;_TextureSample1;Texture Sample 0;0;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;7;-855.8754,-181.2882;Inherit;False;4;4;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.IndirectSpecularLight;8;-737.5754,316.9116;Inherit;False;Tangent;3;0;FLOAT3;0,0,1;False;1;FLOAT;0.7;False;2;FLOAT;1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SwizzleNode;9;-655.2753,-243.0882;Inherit;False;FLOAT;3;1;2;3;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SwizzleNode;10;-621.9753,46.1118;Inherit;False;FLOAT3;0;1;2;3;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;11;-417.1164,213.7611;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ClampOpNode;12;-479.0753,-238.0882;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=E9E0F08F76C835043DCD40F8D06B49C4842BF53F